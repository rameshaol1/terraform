...
resource "aws_db_subnet_group" "mariadb-subnets" {
    ...
    description = "Amazon aws rds subnet"
    subnet_ids = [aws_subnet.levelupvpc-private-2.id]
}
...
resource "aws_db_parameter_group" "levelup-mariadb-parameters" {
    ...
    family = "mariadb10.4"
    description = "Mariadb parameters group"
...
resource "aws_db_instance" "levelup-mariadb" {
  ...
  availability_zone       = aws_subnet.levelupvpc-private-2.availability_zone # prefered AZ
